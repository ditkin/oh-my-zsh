...
alias gpuf='git push upstream --force'
alias gpui='git push upstream integration'
alias gpud='git push upstream development'

alias crazympush='git push upstream --force master'
alias crazyrpush='git push upstream --force release'
alias crazyipush='git push upstream --force integration'
alias crazydpush='git push upstream --force development'
ggf() {
